...
if [[ ! -f min.out ]]; then
    ...
    sander -O \
      -i min.in \
      -p "/nas/longleaf/home/emainas/software/dcdftbmd.2.0/molecules/MEA/qmmd/systems/TPS/solv_6.5/prep/solv.parm7" \
      -c "/nas/longleaf/home/emainas/software/dcdftbmd.2.0/molecules/MEA/qmmd/systems/TPS/solv_6.5/prep/solv.rst7" \
      -r min.rst7 \
      -o min.out \
      -inf min.info
else
