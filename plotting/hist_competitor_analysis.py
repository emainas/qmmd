#!/usr/bin/env python3
"""Frame-aligned conformational and competitor observables for histidine."""
...
HIST_COMPETITOR_LABELS = ("N", "ND1", "NE2", "O", "O1")
...
def _time_tolerance(target_times: np.ndarray) -> float:
    ...
    return 0.51 * float(np.median(positive_steps)) if positive_steps.size else 1.0e-6
