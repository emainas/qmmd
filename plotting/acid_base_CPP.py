#!/usr/bin/env python3
"""CPP adaptation of the HIST/PRD summary with integrated NB/NC comparison.
...
def plot_wire_csv(
    ...
    if has_hist_column:
        ...
        from cpp_competitor_analysis import classify_histidine_conformers
    ...
    if has_hist_competitor_column:
        ...
        ax_competitor_charge.set_ylabel("CPP heavy-atom charge tier")
        ...
        ax_competitor_wire.set_ylabel("CPP heavy-atom site")
        ...
        for band_index, label in enumerate(competitor_labels):
            ...
            ax_competitor_coord.plot(x, values, label=label,
                color="steelblue" if label == "NB" else "darkorange", linewidth=1)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=3,
        help=(
            "Maximum water bridges searched for CPP heavy-atom site paths "
    ...
    from cpp_competitor_analysis import (
        calculate_histidine_competitor_geometry, save_histidine_competitor_data,
    )
    symbols = read_xyz_symbols(args.traj)
    hist_competitor_endpoints = {"NB": 19, "NC": 31}
    if args.solute_atoms != 77 or symbols[18] != "N" or symbols[30] != "N" or symbols[19] != "H":
        raise ValueError("Expected CPP NB19, HB20, NC31; 77 solute atoms")
    ...
    hist_competitor_wires, hist_competitor_coordination = calculate_histidine_competitor_geometry(
        ...
        angle_cutoff=args.angle_cutoff)
    hist_competitor_out = args.out.with_name(f"{args.out.stem}_cpp_competitors.csv")
    ...
    if mulliken_path.exists():
        ...
        if (
            ...
            hist_charge_out = (
                ...
                or args.out.with_name(f"{args.out.stem}_cpp_heavy_charges.csv")
            )
            save_histidine_charge_data(
                hist_charge_out,
                hist_charge_times,
